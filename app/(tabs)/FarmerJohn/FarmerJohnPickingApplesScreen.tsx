...
export default function FarmerJohnPickingApplesScreen() {
  ...
  const handleSubmit = () => {
    if (answer.trim() === "2") {
      // Assuming the initial count was 10 apples, with 4 picked
      setStage(0);
      setAnswer("");
            ...
            >
              {stage === 0 && (
                <Text style={styles.storyText}>
                  Farmer John grabs a woven basket and starts reaching up to
                  pick the apples, carefully placing each one into the basket.
                  As he picks the apples, the tree starts to look a little
                  emptier.
                </Text>
              )}
              {stage === 1 && (
                <Text style={styles.storyText}>
                  “I’ve picked a few apples to take to the market,” he says,
                  holding up the basket with a proud smile. “But now I’m
                  wondering how many are still left on the tree. Can you help me
                  figure that out?”
                </Text>
              )}
              {stage === 2 && (
                <>
                  <Text style={styles.questionText}>
                    If Farmer John picked 4 apples, how many apples are left on
                    the tree?
                  </Text>
                  <TextInput
                    style={styles.input}
