...
export default function FarmerJohnPlantingSeedsScreen() {
  ...
  const handleSubmit = () => {
    if (answer.trim() === "5") {
      // Correct answer for 8 - 3
      setStage(0);
      setAnswer("");
      alert(
        "Perfect! With these seeds, we’ll have plenty of new trees next year."
      );
            ...
            >
              {stage === 0 && (
                <Text style={styles.storyText}>
                  Farmer John decides it’s time to plant some apple seeds to
                  grow new trees for next season. He opens his hand, showing a
                  few tiny seeds lying in his palm.
                </Text>
              )}
              {stage === 1 && (
                <Text style={styles.storyText}>
                  “If I plant these seeds now, we’ll have even more apples next
                  year,” he says. “But I want to save a few for another day. Can
                  you help me figure out how many I should plant today?”
                </Text>
              )}
              {stage === 2 && (
                <>
                  <Text style={styles.questionText}>
                    Farmer John has 8 apple seeds. He wants to keep 3 for next
                    year. How many seeds should he plant today?
                  </Text>
                  <TextInput
                    style={styles.input}
