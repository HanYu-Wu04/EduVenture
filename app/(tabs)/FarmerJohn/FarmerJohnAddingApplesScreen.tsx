...
export default function FarmerJohnAddingApplesScreen() {
  ...
  const handleSubmit = () => {
    if (answer.trim() === '10') { // Correct answer for 4 + 2
      setStage(0);
      setAnswer("");
        ...
        >
          <View style={styles.contentContainer}>
            <LinearGradient colors={['rgba(255, 255, 255, 0.8)', 'rgba(255, 255, 255, 0.6)']} style={styles.storyContainer}>
              {stage === 0 && <Text style={styles.storyText}>Farmer John finds a few more apples lying on the ground, fresh and shiny. He picks them up and adds them to his basket.</Text>}
              {stage === 1 && <Text style={styles.storyText}>“The more, the merrier!” he laughs. “Now we have even more apples to take to the market. Let’s make sure we know exactly how many are in the basket.”</Text>}
              {stage === 2 && (
                <>
                  <Text style={styles.questionText}>Farmer John already has 6 apples in his basket. He finds 4 more on the ground and puts them in. How many apples are in his basket now?</Text>
                  <TextInput
                    style={styles.input}
