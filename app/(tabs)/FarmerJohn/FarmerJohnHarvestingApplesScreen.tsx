...
export default function FarmerJohnHarvestingApplesScreen() {
  ...
  const handleSubmit = () => {
    if (answer.trim() === '15') { // Correct answer for 7 + 5
      setStage(0);
        ...
        >
          <View style={styles.contentContainer}>
            <LinearGradient colors={['rgba(255, 255, 255, 0.8)', 'rgba(255, 255, 255, 0.6)']} style={styles.storyContainer}>
              {stage === 0 && <Text style={styles.storyText}>As the sun begins to set, Farmer John looks around his orchard and decides it’s time to gather the remaining apples for the day. He heads to the last apple tree and picks the ripe apples from its branches.</Text>}
              {stage === 1 && <Text style={styles.storyText}>“This has been such a great day,” he says, looking at the apples in his basket. “Let’s see how many we have altogether.”</Text>}
              {stage === 2 && (
                <>
                  <Text style={styles.questionText}>Farmer John collects 7 apples from the last tree. If he had 8 in his basket already, how many does he have in total?</Text>
                  <TextInput
                    style={styles.input}
