...
export default function FarmerJohnFeedingAnimalsScreen() {
  ...
  const handleSubmit = () => {
    if (answer.trim() === '4') { // Correct answer for 10 - 3
      setStage(0);
      setAnswer("");
      alert("You’ve got it! Now there are just enough carrots for the rest of the rabbits.");
        ...
        >
          <View style={styles.contentContainer}>
            <LinearGradient colors={['rgba(255, 255, 255, 0.8)', 'rgba(255, 255, 255, 0.6)']} style={styles.storyContainer}>
              {stage === 0 && <Text style={styles.storyText}>It’s time to take a break from picking apples and feed the animals. Farmer John heads over to a small fenced area where the rabbits are hopping around, waiting for their treat. He has a bunch of carrots in his hand.</Text>}
              {stage === 1 && <Text style={styles.storyText}>“Look at these hungry little rabbits!” Farmer John says. “Each one of them wants a carrot. Let’s see if we can figure out how many carrots I’ll have left after feeding a few of them.”</Text>}
              {stage === 2 && (
                <>
                  <Text style={styles.questionText}>Farmer John feeds 2 rabbits. How many carrots does he have left if he started with 6?</Text>
                  <TextInput
                    style={styles.input}
