import {
  ...
  const questions = [
    {
      question: "There are 3 rows of trees, and each row has 4 glowing orbs. How many orbs are there in total?",
      correctAnswer: '12',
      hint: "Multiply the number of rows by the orbs in each row.",
    },
    {
      question: "You have 12 items, and each boat can carry 3 items. How many boats do you need?",
      correctAnswer: '4',
      hint: "Divide the total number of items by the capacity of each boat.",
    },
    {
      question: "The animals give you 24 berries to eat. If you only eat 4 berries at each stop, how many stops can you make?",
      correctAnswer: '6',
      hint: "Divide the total berries by the berries eaten at each stop.",
    },
    {
      question: "You have 5 groups of weights, and each group weighs 3 kilograms. What is the total weight?",
      correctAnswer: '15',
